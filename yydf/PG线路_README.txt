在压缩包释放解压后，去XYQTVBox目录里找到tokenm.json，并填寫必要的内容
...
pikpak登录地址：需要梯子吧！
https://mypikpak.com/s/VN7POm7LowF1qF1kF49QLNXxo1/VN7PNgJwq0j02hNRW-gexKueo1/VN8qZURVhIG1VA9V5cCU6j2Bo1/VNftzqD4TBSEC0sbkOuTqyYko1

优化迅雷/PikPak分享资源加载机制，提高打开成功率。增加pikpakshare的搜索功能，可以在自己配置的网盘分享中搜索内容了呢，海量的影视剧有救了呢。具体配置方式： {"key":"PikPakShare","name":"PikPak分享","type":3,"api":"csp_PikPakShare","searchable":1,"quickSearch":1, "changeable":0, "filterable":0, "timeout":60, "ext":"./lib/tokenm.json$$$./lib/pikpakclass.json$$$./lib/pikpakclass.txt"}, 
包内XYQTVBox目录集成了影视剧的pikpakclasss.json和搜索文件pikpakclass.txt，可以参考编写和修改。

aliproxy_url支持md5校验，例如http://abc.xyz/aliproxy.gz;md5=01234567890123456，文件的md5在lib/aliproxy.md5，使用远程aliproxy下载地址时可以用这个东西防止每次都下载。